...
# EXPERIMENTO FEATURETOOLS. A construção de variáveis saiu daqui e foi para
# `lai_triagem/variaveis_featuretools.py`, onde as janelas passam a ser
# `cutoff_time` e `training_window` em vez de `searchsorted`/`merge_asof` à
# mão. O resto deste arquivo — corte temporal, variantes, métrica, artefato —
# não mudou.
