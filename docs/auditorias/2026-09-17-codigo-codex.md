...
> para os correntes veja [`../METRICAS.md`](../METRICAS.md). Os caminhos
> relativos dos links foram reapontados para a nova profundidade; o texto
> em si nao foi alterado.
